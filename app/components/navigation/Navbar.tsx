...
export const Navbar = () => {
  return (
    <header className="fixed top-10 left-0 animate-fade-in-down [--animation-delay:600ms] right-0 px-4 py-1 bg-background/40 backdrop-blur-lg border border-white rounded-2xl shadow-xl z-50 max-w-6xl mx-auto w-11/12">
        ...
        <nav className="hidden md:flex">
          <ul className="flex items-center justify-center gap-8">
            {nav_links.map((link, index) => (
              <li key={index} className="hover:text-foreground/80 text-sm">

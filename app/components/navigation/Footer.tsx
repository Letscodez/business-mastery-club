...
export function Footer() {
  return (
    <footer className="overflow-x-hidden w-screen">
      <div className="flex flex-col items-center justify-center border-t border-border pt-16 pb-8 px-6 lg:px-8 w-full max-w-6xl mx-auto lg:pt-32 relative ">

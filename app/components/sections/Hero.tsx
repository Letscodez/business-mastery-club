...
export const Hero = () => {
  const heroTitle = "Inspire Excellence in Business - Learn, Lead, Succeed";

  return (
    <section className="animate-fade-in-down h-screen mb-12 w-full mx-auto max-w-screen-xl px-4 md:px-0">
      <Grids />
      <div className="flex flex-col items-center justify-center py-20 h-full">
        ...
        <div className="flex flex-col items-center mt-8 max-w-4xl w-11/12 md:w-full">
          ...
          <div className="flex relative items-center justify-center mt-8 md:mt-12 w-full">
            <span className="flex items-center justify-center w-max rounded-full border-t border-foreground/30 bg-white/20 backdrop-blur-lg px-2 py-1 md:py-2 gap-2 md:gap-8 shadow-3xl shadow-background/40">
              ...
              <button className="relative inline-flex h-10 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-white group">
                ...
                <Link
                  href="#WhyOurClub"
                  className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-[#333] px-3 text-sm font-medium text-white backdrop-blur-3xl"
                >
                  Learn More
